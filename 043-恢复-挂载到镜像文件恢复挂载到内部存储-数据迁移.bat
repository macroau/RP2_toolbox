...
echo.
echo =====================================================
echo + 迁移镜像文件数据到内部存储脚本 V1.1      20200920 +
echo =====================================================
echo +   本bat脚本在取消挂载后，用来迁移(恢复)镜像文件中 +
...
adb shell mount -o rw -t ext4 /dev/block/loop4 /data/temp4
...
adb shell rm /data/temp4/0/synctrace.*
::adb shell rm -rf /data/temp4/0/RetroArch/cheats/*
adb shell cp -ar /data/temp4/* %MOUNT_POINT%/
::adb shell "(cd /data/temp4; tar -cf - . ) | tar -xf - -C %MOUNT_POINT%"
